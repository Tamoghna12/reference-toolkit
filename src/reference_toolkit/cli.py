...
def main() -> int:
    ...
    search_p.add_argument("--mailto", help="Email address for API requests (required for polite usage)")
    ...
    resolve_p.add_argument("--mailto", help="Email address for API requests (required for polite usage)")
    ...
    download_p.add_argument("--mailto", help="Email address for API requests (required for polite usage)")
    ...
    pipeline_p.add_argument("--mailto", help="Email address for API requests (required for polite usage)")
    ...
    contacts_p.add_argument("--mailto", help="Email address for API requests (required for polite usage)")
